...
STATETRACE_ACTION_META  = "polls.statetrace.action_meta"

STATETRACE_SESSION_META = "polls.statetrace.session_meta"

STATETRACE_REQUEST_FILTER = "polls.statetrace.filter_func"
